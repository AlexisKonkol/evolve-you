...
const navSections = [
  {
    ...
    items: [
      { label: "Identity Reset",      href: "/onboarding",          icon: Sparkles,   desc: "Rediscover who you are beyond your job" },
      { label: "Life Clarity",        href: "/life-clarity",        icon: Brain,      desc: "Deep reflection on your values & energy" },
      { label: "Identity Dashboard",  href: "/identity-dashboard",  icon: Map,        desc: "Your identity profile at a glance"       },
      { label: "Pathly Report",       href: "/report",              icon: Star,       desc: "Your personalized insight report"        },
      { label: "Path Journal",        href: "/journal",             icon: BookOpen,   desc: "Reflect and track your patterns"         },
      { label: "Path Mentor",         href: "/mentor",              icon: Compass,    desc: "A thoughtful guide through questions"    },
      { label: "Clarity Engine",      href: "/clarity-engine",      icon: Lightbulb,  desc: "From identity confusion to clarity"      },
      { label: "Confidence Builder",  href: "/confidence-builder",  icon: Shield,     desc: "Build belief in who you're becoming"     },
    ],
  },
  {
    label: "Explore Paths",
    ...
    items: [
      { label: "Path Exploration",    href: "/opportunity-engine", icon: Rocket,    desc: "Paths aligned to your identity profile"  },
      { label: "Future Vision",       href: "/future-vision",      icon: Eye,       desc: "Define who you want to become"           },
      { label: "Future You",          href: "/future-you",         icon: Sparkles,  desc: "Visualize possible future versions"      },
      { label: "Path Finder",         href: "/path-finder",        icon: Compass,   desc: "AI-powered path discovery"               },
      { label: "Path Graph",          href: "/path-graph",         icon: Map,       desc: "Explore your web of possibilities"       },
      { label: "Reinvention Paths",   href: "/paths",              icon: GitBranch, desc: "Step-by-step reinvention roadmaps"       },
      { label: "Pathly Intelligence", href: "/intelligence",       icon: Brain,     desc: "Patterns across all explorations"        },
    ],
  },
  {
    label: "Experiment",
    ...
    items: [
      { label: "Life Experiments",    href: "/experiments",  icon: FlaskConical, desc: "Test new directions with low commitment"  },
      { label: "Learning Modules",    href: "/learn",        icon: BookOpen,     desc: "Short lessons built around your identity" },
      { label: "Skill Builder",       href: "/learn",        icon: Wrench,       desc: "Build skills for who you're becoming"     },
      { label: "Opportunity Radar",   href: "/opportunities",icon: TrendingUp,   desc: "Emerging paths worth exploring"           },
    ],
  },
  {
    label: "Community",
