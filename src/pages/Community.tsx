...
const recentPosts = [
  {
    ...
    time: "2 hours ago",
    content: "After 8 months of feeling lost after my layoff, I finally landed my first client as an AI workflow consultant. The EVOLVE path was my roadmap. Don't give up. 🙌",
    likes: 147,
    replies: 38,
  },
  {
